 ...
 * 3. Allow multi-character delimiters like 是： or is: (common in Chinese/English).
...
export function extractCode(text: string): string | null {
  // DELIM: at least one explicit delimiter must follow the code keyword before the
  // code itself. Allowed delimiters: colon (: or ：), "is", Chinese 是/为, Japanese です.
  // Multiple delimiters in sequence are OK (e.g. "是：", "is :", "为 ：").
  // Whitespace around the delimiter is allowed.
  //
